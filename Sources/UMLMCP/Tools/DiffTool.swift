...
/// `uml_diff` — the structural delta between two revisions of a codebase: added/removed types,
/// added/removed/changed relationships, and notable metric movement. Mirrors `uml diff --format json`.
