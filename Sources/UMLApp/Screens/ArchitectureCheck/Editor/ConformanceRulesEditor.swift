...
/// The form for authoring a `ConformanceRules` set in the UI — one section per rule kind. Bound
/// directly to a working copy held by the editor sheet; serialized to YAML on save.
struct ConformanceRulesEditor: View {
    @Binding var rules: ConformanceRules
