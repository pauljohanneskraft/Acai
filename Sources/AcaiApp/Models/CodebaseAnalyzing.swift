...
/// Split out of `CodebaseAnalyzer` (mirroring `GitHubRepositoryService`) so a UI-test process can
/// swap in a parse-free conformance instead of running a real parse.
...
/// specifically — a journey that stages none (e.g. `OpenSeededProjectGenerateDiagramTests`) still
/// gets the real analyzer.
