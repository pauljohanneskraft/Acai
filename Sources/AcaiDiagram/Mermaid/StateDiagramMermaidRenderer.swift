/// `initial` and `final` states map to Mermaid's `[*]` start/end pseudo-state; other states are
/// declared with a stable id and a display label. Composite sub-states are flattened (the
/// value-flow analyser does not currently emit them).
