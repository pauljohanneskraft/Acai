...
/// Covers `uml quality` — the merged code-quality check + smells: rule/flag parsing, baseline drift,
...
struct QualityCommandTests {
    ...
    private func parseQuality(_ arguments: [String]) throws -> UMLCommand.Quality {
