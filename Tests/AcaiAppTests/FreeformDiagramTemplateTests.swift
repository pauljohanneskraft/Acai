...
/// `FreeformDiagramTemplate`: the pre-arranged starter node sets offered in "New Freeform Diagram,"
/// and `FreeformDiagramEditor.add(to:name:template:)`'s seeding of them.
